...
class List_ticket_tek extends CI_Controller
{
	...
	public function index_tugas()
	{
		...
		if($this->session->userdata('level') == "Technician"){
			...
			// $data['rfo'] 	= $this->model_app->daftar_tugas($id_user)->result();
	...
	public function detail_update($id)
	{
		...
		if($this->session->userdata('level') == "Technician"){
			...
			$data['dd_rfo'] = $this->model_app->dropdown_rfo();
			$data['id_rfo'] = "";
	...
	public function update($id)
	{
        ...
        //                             <strong>Failed!</strong> Isi Deskripsi Terlebih dahulu!
        //                     	</div>'
        //     )
        // );
		$this->form_validation->set_rules('id_rca', 'Id_rca', 'required',
            array(
                'required' => '<div class="alert alert-danger alert-dismissable">
                                    <strong>Failed!</strong> Isi RCA Terlebih dahulu!
                            	</div>'
            )
        );
	...
	public function change($id)
	{
		...
		$this->form_validation->set_rules('id_kategori', 'Id_kategori', 'required',
			array(
				'required' => '<div class="alert alert-danger alert-dismissable">
									<strong>Failed!</strong> Please Choose the Category.
							   </div>'
			)
		);

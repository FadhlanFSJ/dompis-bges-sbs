...
class List_ticket_user extends CI_Controller
{
	...
	public function buat()
	{
		...
		if($this->session->userdata('level') == "Helpdesk"){
			//Menyusun template Create ticket
			$data['title'] 	  = "Create Ticket";
			$data['navbar']   = "navbar";
			$data['sidebar']  = "sidebar";
			$data['body']     = "ticketHelpdesk/buatticket_hd";
	...
	public function submit()
	{
		...
		if($this->form_validation->run() == FALSE){
			...
			if($this->session->userdata('level') == "Helpdesk"){
				...
				$data['navbar']   = "navbar";
				$data['sidebar']  = "sidebar";
				$data['body']     = "ticketHelpdesk/buatticket";
...
/////////////////////////////////////////////////////////////////////////////My Ticket/////////////////////////////////////////////////////////////////////////////
	...
	public function index()
	{
		...
		if($this->session->userdata('level') == "Helpdesk"){
			...
			$data['navbar']   = "navbar";
			$data['sidebar']  = "sidebar";
			$data['body']     = "ticketHelpdesk/listticket_hd";
	...
	public function detail($id)
	{
		...
		if($this->session->userdata('level') == "Helpdesk"){
			...
			$data['navbar']   = "navbar";
			$data['sidebar']  = "sidebar";
			$data['body']     = "ticketHelpdesk/detail";

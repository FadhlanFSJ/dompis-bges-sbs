	...
	<form method="post" action="<?php echo site_url('List_ticket_tek/update/'.$detail['id_ticket']); ?>" enctype="multipart/form-data">
		<div class="card shadow mb-4">
			...
			<div class="card-body">
				...
				<h6 class="m-0 font-weight-bold text-primary">Presentase Progress</h6><br>
		...
		<div class="card shadow mb-4">
			...
			<div class="card-body">
				...
				<div class="form-group">
					<label class="m-0 font-weight-bold text-primary">Pilih Progress</label> 
					<select name="progress" class="form-control" id="progress">
						<?php for ($i = $detail['progress'] ; $i <= 100; $i += 20) { ?>
							<option value="<?php echo $i; ?>">Progress <?php echo $i; ?> %</option>
						<?php } ?>
					</select>
					<code>*isi deskripsi terlebih dahulu, sebelum memilih presentase progress</code>
				</div><hr>
				<div class="form-group">
					<label class="m-0 font-weight-bold text-primary">Detail RFO</label>
					<?php echo form_dropdown('id_rfo', $dd_rfo, $id_rfo, 'id="rfo" class="form-control"');?>
					<code>* Isi Progress sampai 100% terlebih dahulu sebelum memilih RFO!</code>
				</div>
				<div class="form-group">
					...
					<input type="file" name="fileupdate" size="20" />
				</div>

		...
		<div class="card shadow mb-4">
			...
			<div class="card-body">
				...
				<div class="form-group">
					<h6 class="m-0 font-weight-bold text-primary">Describe Your Analysis</h6><br>
				...
				<div class="form-group">
					...
					<code>*Describe your analysis first before choose the category</code>
				</div><hr>
				...
				<div class="form-group">
					...
					<code>*Describe your analysis first before choose the sub category</code>
				</div><hr>
				<div class="form-group">

<div class="container-fluid">
	<h1 class="h3 mb-0 text-gray-800">Tiket Assigned</h1>
	<p class="mb-4">List Tiket / Work Order Anda .</p>
	...
	<div class="card shadow mb-4">
		...
		<div class="card-body">
			...
			Please go to <code>Tiket -> List Assignment</code> after approve the tiket for update progress the tiket.
		</div>
	</div>
</div>

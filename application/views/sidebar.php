<div class="sidebar-wrapper active">
    <div class="sidebar-header position-relative">
        <div class="d-flex justify-content-between align-items-center">
            <div class="logo">
                <img src="<?php echo base_url('assets/compiled/svg/logo.svg')?>" alt="Logo" srcset="">
            </div>
    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            <?php } else if ($this->session->userdata('level') == "Technician") { ?>
                <li class="sidebar-item">
                    <a href="<?php echo site_url('Dashboard') ?>" class="sidebar-link">
                        <i class="bi bi-grid-fill"></i>
                        <span>Dashboard</span>
            ...
            <?php } else if ($this->session->userdata('level') == "User") { ?>
                <li class="sidebar-item">
                    <a href="<?php echo site_url('List_ticket_user/buat') ?>" class="sidebar-link">
                ...
                <li class="sidebar-item">
                    <a href="<?php echo site_url('List_ticket_user') ?>" class="sidebar-link">

<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-gray-800">
				<?php echo " Tiket from ".$detail['nama']." (" .$detail['tanggal'].")" ?>
			</h6>
		</div>
		<div class="card-body">
			...
			<div class="font-weight-bold">
				...
				<?php } else { ?>
					<div style="color: <?php echo $detail['warna']?>">
						...
						<?php echo $detail['nama_kondisi'] ?> - <?php echo $detail['waktu_respon'] ?> Minutes
					</div>
				<?php } ?>
			</div><hr>
	...
	<div class="row">
		<div class="col-lg-6 mb-4">
			<div class="card shadow mb-4">
				<div class="card-header py-3">
					<h6 class="m-0 font-weight-bold text-primary">Tracking System</h6>
				</div>
			...
			<div class="card shadow mb-4">
				<div class="card-header py-3">
					<h6 class="m-0 font-weight-bold text-primary">
						<?php echo " Progress By ".$detail['nama_teknisi'] ?></h6>
				</div>
				<div class="card-body">
					<h6 class="font-weight-bold text-primary">Presentase Progress <span class="float-right text-primary"><?php echo $detail['progress'] ?>%</span></h6>
					...
					<h6 class="m-0 font-weight-bold text-primary">Max TTR</h6>
					<div class="font-weight-bold">
					...
					<h6 class="m-0 font-weight-bold text-primary">Close Progress</h6>
					<div class="font-weight-bold">

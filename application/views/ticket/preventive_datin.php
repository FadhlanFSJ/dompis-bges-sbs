<div class="container-fluid">
		<div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="<?php echo site_url('Dashboard/detail_datin') ?>"><button class="btn btn-primary"><i class="fa fa-caret-left"></i> Back to Dashboard</button></a>
		</div>
	<!-- Datatable -->
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-gray-800">List Tiket Preventive</h6>
		</div>
		<div class="card-body">
			<div class="table-responsive">
				<table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
					...
					<tbody>
						<?php $no = 1; foreach ($listticket_prev_datin as $row){?>
							<tr>
								<td><?php echo $no ?></td>

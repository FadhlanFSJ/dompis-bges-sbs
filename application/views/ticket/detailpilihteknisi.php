<div class="container-fluid">
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 text-gray-800">Assign Teknisi <?php echo $detail['id_ticket']?></h1>
	</div><hr>
			...
			<div class="card shadow mb-4">
				<div class="card-header py-3">
					<h6 class="m-0 font-weight-bold text-primary">
						<?php echo " Progress WO By ".$detail['nama_teknisi'] ?></h6>
				</div>
				<div class="card-body">
					...
					<h6 class="m-0 font-weight-bold text-primary">Close</h6>
					<div class="font-weight-bold">
	...
	<div class="card shadow mb-4">
	    <div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-gray-800">Choose Teknisi</h6>
		</div>
		<div class="card-body">

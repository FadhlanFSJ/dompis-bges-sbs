<div class="container-fluid">
	<h1 class="h3 mb-0 text-gray-800">Divisi</h1><hr>
	...
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-gray-800">Data of Divisi</h6><hr>
			<a href="#modal-fade" title="Add Department" class="btn btn-primary" data-toggle="modal">
				<i class="fa fa-plus"></i> Add Divisi
			</a>
		</div>
...
<div id="modal-fade" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<h6 class="m-0 font-weight-bold text-gray-800">Add Divisi</h6>
		</div>

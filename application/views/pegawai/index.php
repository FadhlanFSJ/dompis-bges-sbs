...
<div class="container-fluid">
	<h1 class="h3 mb-0 text-gray-800">Data Naker</h1><hr>
	...
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			...
			<a href="#modal-fade" title="Add Employee" class="btn btn-primary" data-toggle="modal">
				<i class="fa fa-plus"></i> Tambah Naker
			</a>
		</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h6 class="m-0 font-weight-bold text-gray-800">Tambah Naker</h6>
			</div>
			<div class="modal-body">
				...
				<form id="form-validation" action="<?php echo site_url('Pegawai/tambah') ?>" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<input class="form-control" name="nik" placeholder="Input here..." rows="3" maxlength="8">
					</div>

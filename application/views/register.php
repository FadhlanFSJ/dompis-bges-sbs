...
<head>
    ...
    <title>Register - DOMPIS BGES</title>
  ...
  <link rel="stylesheet" crossorigin href="<?php echo base_url('/assets/compiled/css/auth.css')?>">
</head>
    ...
    <div class="col-lg-5 col-12">
        <div id="auth-left">
            ...
            <div class="text-center mt-5 text-lg fs-4">
                <p class='text-gray-600'>Already have an account? <a href="<?php echo site_url('Login') ?>" class="font-bold">Log
                        in</a>.</p>
            </div>
        </div>
    </div>

<?php if ($this->session->userdata('level') == "Admin") { ?>
	<div class="container-fluid">
		<div class="d-sm-flex align-items-center justify-content-between mb-4">
			<h1 class="h3 mb-0 text-gray-800">DASHBOARD POTS</h1>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
				<div class="card bg-danger text-white shadow h-100 py-2">
					<div class="card-body">
						<div class="row no-gutters align-items-center">
							<div class="col mr-2">
								<div class="text-xs font-weight-bold text-uppercase mb-1">Jumlah Tiket Voice</div>
								<div class="h5 mb-0 font-weight-bold"><?php echo $total_voice ?></div>
							</div>
							<div class="col-auto">
				...
				<div class="card bg-hsi-sts text-white shadow h-100 py-2">
					<div class="card-body">
						<div class="row no-gutters align-items-center">
							<div class="col mr-2">
							<div class="text-xs font-weight-bold text-uppercase mb-1">Status Tiket POTS</div>
								<table>
									<tr><div class="small font-weight-bold text-uppercase mb-1"><td>Tiket Close</td> <td>:</td> <td></td> <td><?php echo $total_voice ?></td></div></tr>
									<tr><div class="small font-weight-bold text-uppercase mb-1"><td>Tiket Comply</td> <td>:</td> <td></td> <td><?php echo $total_voice_comply ?></td></div></tr>
									<tr><div class="small font-weight-bold text-uppercase mb-1"><td>Tiket Not Comply</td> <td>:</td> <td></td> <td><?php echo $total_voice_notcomply ?></td></div></tr>
								</table>
							</div>
							<div class="col-auto">
						...
						<a href="<?php echo site_url('List_ticket/tiket_voice') ?>"><button class="btn btn-primary-pots1">Detail Tiket <i class="fa fa-caret-right"></i></button></a>
					</div>
				</div>
			</div>

			<!--Status Preventive Voice-->
			<div class="col-xl-3 col-md-6 mb-4">
				<div class="card bg-hsi text-white shadow h-100 py-2">
					<div class="card-body">
						<div class="row no-gutters align-items-center">
							<div class="col mr-2">
							<div class="text-xs font-weight-bold text-uppercase mb-1">PREVENTIVE</div>
								<table>
								<div class="h5 mb-0 font-weight-bold"><?php echo $total_voice ?></div>
								<br><br>
								</table>
						...
						<a href="<?php echo site_url('List_ticket/tiket_hsi') ?>"><button class="btn btn-primary-hsi">Detail Tiket <i class="fa fa-caret-right"></i></button></a>
					</div>
				</div>
			</div>
			...
			<div class="col-xl-3 col-md-6 mb-4">
				<div class="card bg-primary text-white shadow h-100 py-2">
					<div class="card-body">
						<div class="row no-gutters align-items-center">
							<div class="col mr-2">
								<div class="text-xs font-weight-bold text-uppercase mb-1">Tiket Voice On Progress</div>
			...
			<div class="col-xl-3 col-md-6 mb-4">
				<div class="card bg-hsi text-white shadow h-100 py-2">
					<div class="card-body">
						...
						<a href="<?php echo site_url('List_ticket/tiket_voice') ?>"><button class="btn btn-primary-hsi">Detail Tiket <i class="fa fa-caret-right"></i></button></a>
					</div>
				</div>
			</div>
